...
A dedicated documentation module for the Repwise application with a modern, customized frontend architecture.
...
The Documentation module is included in the Repwise application by default. If you need to install it manually:
