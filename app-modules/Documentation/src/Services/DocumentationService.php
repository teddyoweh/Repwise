...
namespace Repwise\Documentation\Services;

use Illuminate\Support\Collection;
use Illuminate\Support\Facades\Cache;
use Illuminate\Support\Str;
use Repwise\Documentation\Data\DocumentData;
use Repwise\Documentation\Data\DocumentSearchRequest;
use Repwise\Documentation\Data\DocumentSearchResultData;
...
final class DocumentationService
{
    ...
    public function getDocument(string $type): DocumentData
    {
        ...
        return Cache::remember(
            ...
            fn (): \Repwise\Documentation\Data\DocumentData => DocumentData::fromType($type)
        );
    }
