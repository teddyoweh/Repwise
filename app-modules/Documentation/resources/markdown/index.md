# Repwise Documentation

Welcome to the Repwise documentation hub. Here you'll find guides and resources to help you get the most out of Repwise CRM.
...
The Business Guide provides an overview of Repwise from a business perspective. It explains how Repwise can benefit your organization and how to leverage its features effectively. This is the perfect starting point for business users and decision-makers.
...
The API Documentation provides information for developers who want to integrate with the Repwise API. It includes authentication methods, endpoint details, and best practices for API usage.
</x-documentation::card>
...
The User Workflows guide provides detailed walkthroughs for common business scenarios in Repwise. Learn how to optimize your processes and get the most out of the platform for specific use cases.
...
1. Visit our [GitHub repository](https://github.com/Repwise/repwise)
2. Create a branch with your proposed changes
3. Submit a pull request with a clear description of your improvements

Thank you for using Repwise! 
