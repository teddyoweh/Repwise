...
Repwise is built on the Laravel 12 framework with Filament 3 for the admin panel interface. The front-end uses
...
Repwise includes one premium component in its technology stack:

**Custom Fields** - A powerful Filament plugin developed by Repwise that enables unlimited custom data fields without coding. It's the core of what makes Repwise adaptable to any business workflow.
...
This is the **only** paid component in Repwise. Our commitment to open source remains strong, with this single commercial element supporting the sustainability of the entire ecosystem.

## Core Components

### Models

Repwise's data structure revolves around these key models:
...
To develop Repwise locally, you'll need:
...
Repwise follows Laravel's coding standards and conventions. We enforce these through:
...
Repwise uses several tools to maintain code quality:
...
Repwise uses Git Hooks to automate quality checks during the development process. The hooks are located in the
...
2. Check that the package is properly installed: `composer require repwise/custom-fields`
...
We welcome contributions from developers of all skill levels! Repwise is an open-source project that thrives on community involvement.
...
Remember that all contributions to Repwise are subject to review and must align with the project's goals and quality standards. Working closely with maintainers will help ensure your contribution is accepted and merged efficiently.
