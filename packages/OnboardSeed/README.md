...
A Laravel package for generating consistent demo data for new Repwise teams.
...
namespace Repwise\OnboardSeed\ModelSeeders;

use App\Models\NewEntityType;
use Repwise\OnboardSeed\Support\BaseModelSeeder;
