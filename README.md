...
<p align="center">
  <a href="https://www.repwise.com">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://repwise.com/images/app-preview.png">
      <source media="(prefers-color-scheme: light)" srcset="https://repwise.com/images/app-preview.png">
      <img src="https://repwise.com/images/app-preview.png" alt="Companies view" />
    </picture>
  </a>
</p>
...
Repwise is a regular Laravel application; it's build on top of Laravel 11 / Filament 3 and uses Livewire / Tailwind
...
Visit [github.com/Repwise/repwise/pulls](https://github.com/Repwise/repwise/pulls) and create a pull request.

## Tooling

Repwise uses a few tools to ensure the code quality and consistency. Of course, [Pest](https://pestphp.com) is the
...
Repwise uses [Git Hooks](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks) to ensure the code quality and
