...
test('company uses custom fields', function () {
    ...
    expect(class_implements($company))->toContain(\Repwise\CustomFields\Models\Contracts\HasCustomFields::class)
        ->and(class_uses_recursive($company))->toContain(\Repwise\CustomFields\Models\Concerns\UsesCustomFields::class);
})->todo();
