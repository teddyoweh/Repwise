...
final readonly class GitHubService
{
     ...
     */
    public function getStarsCount(string $owner = 'Repwise', string $repo = 'repwise', int $cacheMinutes = 60): ?int
    {
     ...
     * @param  int  $cacheMinutes  Minutes to cache the result (default: 60)
     */
    public function getFormattedStarsCount(string $owner = 'Repwise', string $repo = 'repwise', int $cacheMinutes = 60): string
    {
