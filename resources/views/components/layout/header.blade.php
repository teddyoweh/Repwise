    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex-shrink-0 w-1/4">
                <a href="{{ url('/') }}" class="flex items-center space-x-2.5 group" aria-label="Repwise Home">
                    <div class="relative overflow-hidden">
                        <img class="h-8 w-auto transition-transform duration-300 group-hover:scale-105" src="{{ asset('repwise-logo.svg') }}" alt="Repwise Logo">
                    </div>
                    <span class="font-bold text-lg text-black dark:text-white hidden sm:block transition-opacity duration-300 group-hover:opacity-80">Repwise</span>
                </a>
            </div>
        ...
        <div class="p-6 flex flex-col h-full">
            ...
            <div class="flex items-center justify-between mb-8">
                <div class="flex items-center space-x-2">
                    <img class="h-7 w-auto" src="{{ asset('repwise-logo.svg') }}" alt="Repwise Logo">
                </div>
