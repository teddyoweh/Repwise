...
<footer class="py-12 md:py-16 border-t border-gray-100 dark:border-gray-900 bg-white dark:bg-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
            ...
            <div class="md:col-span-5 space-y-5">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="font-semibold text-lg text-black dark:text-white">Repwise</span>
                </div>
                ...
                <div class="flex space-x-4">
                    <a href="https://github.com/Repwise/repwise" target="_blank" rel="noopener"
                    ...
                    <a href="https://x.com/repwise" target="_blank" class="text-gray-400 hover:text-primary dark:hover:text-primary-400 transition-colors"
                       aria-label="X">
                    ...
                    <a href="https://www.linkedin.com/company/repwise"  target="_blank" class="text-gray-400 hover:text-primary dark:hover:text-primary-400 transition-colors"
                       aria-label="LinkedIn">
        ...
        <div class="mt-8 flex flex-col md:flex-row md:justify-between items-center">
            <p class="text-gray-500 dark:text-gray-400 text-xs">&copy; {{ date('Y') }} Repwise. All rights
                reserved.</p>
